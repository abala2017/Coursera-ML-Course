...
part1J =  (-1/ m) * sum(sum(Ymat .* log(HT) + (1-Ymat) .* log(1-HT)));
P2J =(sum((sum(Theta1(:,2:size(Theta1,2)) .^2))') + sum((sum(Theta2(:,2:size(Theta2,2)) .^2))'));
P2J = P2J * (lambda/(2 * m));
J = part1J + P2J;
...
for t = 1:m
  a_1 = X(t,:); # 1 x 401
  z_2 = a_1 * Theta1'; # (1 x 401) x (401 x 25) = (1 x 25)
  a_2 = sigmoid(z_2); # (1 x 25)
  a_2 = [1, a_2]; # (1 x 26)
  z_3 = a_2 * Theta2'; #(1 x 26) x (26 x 10) = (1 x 10)
  a_3 = sigmoid(z_3); # (1 x 10)
  DELTA_3 = a_3 - Ymat(:,t)'; # (1 x 10)
  z_2 = [1, z_2]; #(1 x 26)
